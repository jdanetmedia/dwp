      ...
      <div class="container">
        <div class="row">
          <div class="col s12 m6 push-m3">
            <div class="progress">
              <div class="determinate install2" style="width: 33%"></div>
            </div>
            <div class="card medium">
              <div class="card-content">
                <?php if (!empty($message)) {echo "<p>" . $message . "</p>";} ?>
                <h5>Do you want some demo data for your website?</h5>
                <div class="card-action">
                  <a class="btn waves-effect waves-light right" href="createdemodata.php?data=yes">Yes</a>
                  <a class="btn waves-effect waves-light left" href="finishup.php">No</a>
                </div>
              </div>
            </div>
          </div>
