...
<div class="container">
      ...
      <div class="card medium">
        <div class="card-content">
          ...
          <div class="col s12 m6">
            <p>Order: <br>#<?php echo $orderdetails["OrderInfo"]["OrderNumber"]; ?></p><br>
          ...
          <div class="col s12 m6">
            <p>Order placed at: <br><?php echo $orderdetails["OrderInfo"]["OrderDate"]; ?></p><br>
  ...
  <div class="row">
    ...
    <h4 class="right">Total: $<?php echo $orderdetails["Total"] + $orderdetails["OrderInfo"]["DeliveryPrice"]; ?></h4>
  </div>
